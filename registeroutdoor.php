...
Registrations for Outdoor Sphurti Have Begun!!! 
</marquee></font></div>
</div>
...
<nav>
	<ul>
		<li style="display:block;"><a href="#">Outdoor Sphurti</a></li>
		 
		<li style="display:block;"><a href="registeroutdoor.php">Register</a></li>
...
<h1><font color="3282c2"> Outdoor Sphurti</font></h1>
</div>
...
<tr><td><font color="white" size="5">Portfolio:</font></td><td><div style="color:white">
				<input type="checkbox" name="event[]" value="bball">Basketball<br>
				<input type="checkbox" name="event[]" value="fball">Football<br>
				<input type="checkbox" name="event[]" value="cricket" >Cricket<br>
				<input type="checkbox" name="event[]" value="kabaddi">Kabaddi<br><div>
				</td></tr>
