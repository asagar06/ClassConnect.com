			...
			<table id="t01" align="center" style="padding-top:2em;" cellpadding="3">
				<tr>
					...
					<td colspan="2"><select name="subject">
							<option value="mp_pr">Microprocessors</option>
							<option value="os_pr">Operating Systems</option>
							<option value="sooad_pr">Structured and Object Oriented Analysis and Design</option>
							<option value="cn_pr">Computer Networks</option>
							<option value="wt_pr">Web Technology</option>
