...
Registrations Have Opened<br><br>Register For Your Favourite Portfolios Today!!!
</marquee></font></div>
</div>
...
<nav>
	<ul>
		<li style="display:block;"><a href="illusions.php">Illusions</a></li>
		<li style="display:block;"><a href="teams.php">Teams</a></li> 
		<li style="display:block;"><a href="register1.php">Register</a></li>
		<li style="display:block;"><a href="https://www.facebook.com/Illusion15.vesit?fref=ts">Facebook</a></li>
	</ul>
</nav>
</div>
<div id="heading"align="center">
<h1><font color="3282c2"> Illusions</font></h1>
</div>
...
<tr><td><font color="white" size="5">Portfolio:</font></td><td><div style="color:white">
				<input type="checkbox" name="event[]" value="dance_ill">dance<br>
				<input type="checkbox" name="event[]" value="drama_ill">drama<br>
				<input type="checkbox" name="event[]" value="aesthetics_ill" >aesthetics<br>
				<input type="checkbox" name="event[]" value="sports_ill">Sports<br><div>
				<input type="checkbox" name="event[]" value="literature_ill">Literature<br><div>
				</td></tr>
