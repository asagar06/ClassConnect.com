...
<h1><font color="3282c2">Utsav</font></h1>
</div>
...
<tr><td><font color="white" size="5">Event:</font></td><td><div style="color:white">
				<input type="checkbox" name="event[]" value="dnp">dumsies and pixies<br>
				<input type="checkbox" name="event[]" value="drama">drama<br>
				<input type="checkbox" name="event[]" value="dance" >dance<br>
				<input type="checkbox" name="event[]" value="singing">singing<br><div>
				</td></tr>
