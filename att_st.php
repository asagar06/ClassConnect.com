...
<div id="message" >
	<form action="att_disp.php" method="post">
		<table id="t01" align="center" style="padding-top:2em;" cellpadding="3">
			
				<tr>
					<td><font size="5"face="Calibri"color="white"><label>Select Subject:</label></font></td>
					<td colspan="2"><select name="subject">
							<option value="mp_th">Microprocessors Theory</option>
							<option value="mp_pr">Microprocessors Practical</option>
							<option value="os_th">Operating Systems Theory</option>
							<option value="os_pr">Operating Systems Practical</option>
							<option value="sooad_th">Structured and Object Oriented Analysis and Design Theory</option>
							<option value="sooad_pr">Structured and Object Oriented Analysis and Design Practical</option>
							<option value="cn_th">Computer Networks Theory</option>
							<option value="cn_pr">Computer Networks Practical</option>
							<option value="wt_th">Web Technology Theory</option>
							<option value="wt_pr">Web Technology Practical</option>
							<option value="bce">Business Communication and Ethics</option>
						</select></td>
				</tr>
				<tr>
					<td colspan="3" align="center"><input  type="submit" value="View Attendance"></td>
				</tr>
